...
function game(id){
    ...
    if(turn === 'x' && element.innerHTML == ''){
        element.innerHTML = 'X';
        turn = 'o'
        title.innerHTML = `<span class='text-warning'>O</span> `
    }
    else if(turn === 'o' && element.innerHTML == ''){
        element.innerHTML = 'O';
        turn = 'x'
        title.innerHTML = `<span class='text-warning'>X</span> `
    }
...
function winner(){
    ...
    else if(squares[9] == squares[6] && squares[6] == squares[3] && squares[6]!= ""){
        end(9,6,3)
    }
...
function end(num1 , num2 , num3){
    title.innerHTML = `${squares[num1]} <span class ='text-warning'>Winner!!!</span>`
